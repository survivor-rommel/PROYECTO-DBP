...
public class SubjectListAdapter extends RecyclerView.Adapter<SubjectViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SubjectViewHolder holder, int position) {
        ...
        holder.editIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SubjectUpdateDialogFragment dialogFragment = SubjectUpdateDialogFragment.newInstance(subject, "ACTUALIZAR CURSO", new SubjectCrudListener() {
                    @Override
    ...
    private void showConfirmationDialog(final int subjectId) {
        ...
        alertDialogBuilder.setMessage("¿Estas seguro de querer eliminar este Curso?");
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        query.deleteSubject(subjectId, new QueryResponse<Boolean>() {
                            ...
                            public void onSuccess(Boolean data) {
                                ...
                                Toast.makeText(context, "Curso eliminado con éxito", Toast.LENGTH_SHORT).show();
                            }
