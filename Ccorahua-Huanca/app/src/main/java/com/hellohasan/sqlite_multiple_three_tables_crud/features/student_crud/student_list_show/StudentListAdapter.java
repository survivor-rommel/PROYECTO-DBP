...
public class StudentListAdapter extends RecyclerView.Adapter<StudentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.editImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StudentUpdateDialogFragment dialogFragment = StudentUpdateDialogFragment.newInstance(student, "Estudiante Actualizado", new StudentCrudListener() {
                    @Override
    ...
    private void showConfirmationDialog(final int studentId) {
        ...
        alertDialogBuilder.setMessage("¿ Estas seguro de querer eliminar este Estudiante?");
